    ...
    return (
        ...
        <div className={`relative ${props.className}`}>
            {props.type != 'textarea' ? (
                ...
                className={`mt-7 rounded-sm border-b-4 outline-none p-1 ${fundoErro ? 'bg-red-300' : 'bg-gray-200'} 
                  ${props.erro ? 'border-red-500' :'border-gray-400'}
                    peer mb-1 focus:border-cyan-600 focus:placeholder-transparent ${corTexto} ${props.className}`} 
