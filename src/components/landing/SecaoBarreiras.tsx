            ...
            <div className="flex flex-col py-12 px-20 w-full justify-center  ">
                <div className="flex w-full text-center items-start justify-center bg-cover bg-fixed bg-[url('/images/landing/imagem9.jpg')] bg-[center_top_-150px]">
                    <div className="block w-full h-[400px] "
                        style={{backgroundImage: 'linear-gradient(to right, black, transparent 20%, transparent 80%, black)'}}>
                        <div className="block w-full h-[400px] "
                        style={{backgroundImage: 'linear-gradient(to bottom, black, transparent 40%, transparent 60%, black'}}>
                        </div>
                    </div>
                </div>        
                ...
                md:flex md:flex-row ">
                    ...
                    md:mx-auto md:w-2/3 space-y-2 md:mr-20 bg-center">
                        ...
                        <h3 className="flex flex-col justify-start items-start text-left text-[1.15rem] w-full">
                            <span className="font-extrabold text-start w-full my-2 bg-clip-text text-transparent bg-gradient-to-r from-blue-500 via-teal-400 to-teal-400">Ingressos 3.0</span>
                            ...
                            <span className="font-extrabold text-start w-full mt-5 my-2 bg-clip-text text-transparent bg-gradient-to-r from-blue-500 via-teal-400 to-teal-400">NFT Membership</span>
