...
const beneficios = [
  {
    imageUrl: './images/landing/singer2.svg',
    subtitulo: 'Experiência únicas',
    titulo: 'Eventos com artistas',
    descricao: [
  ...
  {
    imageUrl: './images/landing/ticket.svg',
    subtitulo: 'Confiabilidade',
    titulo: 'Ingressos 3.0',
    descricao: [
  ...
  {
    imageUrl: './images/landing/singer.svg',
    subtitulo: 'Vanguarda',
...
export default function SecaoCadastro() {
  return (
    <section id='beneficios' className='relative'>
      <div className='flex flex-col w-auto px-5 md:px-auto items-center justify-center bg-black py-14'>
        <div className='flex flex-col w-full items-center justify-center text-center'>
          <h1 className='font-extrabold text-white leading-tighter tracking-tighter mb-20'>
            Conheça os benefícios do nosso ecossistema
          </h1>
          ...
          {beneficios.map((val) => {
            return (
              ...
              >
                 ...
                 */}
                <span className='items-center justify-center flex mx-auto'>
                  <img src={val.imageUrl} width={50}></img>
                </span>
                {/* <h6 className="flex w-full items-start font-semibold mt-5 leading-tighter tracking-tighter">{val.subtitulo}</h6> */}

                {/* TITULO GRANDE */}
                <h2 className='flex items-start font-bold mt-5 mb-3 leading-tighter tracking-tighter'>
                  {val.titulo}
                </h2>
                ...
                <ul className='flex flex-col mx-5'>
                  ...
                  {val.descricao.map((val, key) => {
                    return (
                      <li key={key} className='list-disc text-base'>
                        {val}
                      </li>
                    );
                  })}
