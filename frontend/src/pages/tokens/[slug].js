...
const Token = ({ article, categories }) => {
  ...
  return (
    <Layout>
      <section
        className='mt-36 relative flex flex-col space-y-2 w-full rounded-tl-xl justify-center items-start 
    px-5 lg:px-10'
      >
        <div
            ...
            >
              ...
              <div
                className='flex w-full items-center justify-center
                          '
              >
                <img src={imageUrl} className='flex items-center w-full '></img>
              </div>
            </div>
