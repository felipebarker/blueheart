          ...
          <ul className='grid grid-cols-4 items-start justify-center w-full space-x-10'>
            ...
            <li className='flex flex-col list-decimal items-center justify-center '>
              ...
              <span className='h-full'>
                ...
                <h4 className='text-justify'>
                  Sendo ingresso ou Membership, o seleto grupo de fãs detentores
                  dos NFTs terão contato direto com o artista, com benefícios e
                  ofertas registradas no ativo, exclusivos para os detentores.
                </h4>
              </span>
            </li>
            {/* </Fade>
            ...
            <li className='flex flex-col list-decimal items-center justify-center'>
              ...
              <span className='h-full'>
                ...
                <h4 className='text-justify'>
                  ...
                  colecionável. Bem vindo à nova indústria do entretenimento da
                  Web 3.0!
                </h4>
              </span>
            </li>
